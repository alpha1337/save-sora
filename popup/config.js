/**
 * Shared popup constants.
 */

/**
 * Interval used to poll the background worker for progress updates.
 */
...
/**
 * Interval used to rotate the playful fetch status copy.
 */
export const FETCH_STATUS_ROTATION_MS = 5000;

/**
 * Human-friendly loading phrases shown while the extension scans Sora.
 */
export const FETCH_STATUS_MESSAGES = [
